...
% Owner: DG (Loc)
% Convention: theme-based synthesis (NOT "Smith (2023) did X").
% Each theme summarizes several works and ends positioning our study.
% Citations use \cite{key}; keys must match Paper/references.bib.
% =====================================================================
...
threshold of $\kappa \geq 0.70$. To our knowledge, this is the first study to
benchmark automated reproducibility assessment as a human-agreement task on this
domain.
